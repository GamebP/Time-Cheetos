...
public:
	...
	EFortItemTier Tier() {
		return *(EFortItemTier*)((uintptr_t)this + 0x74); //FortItemDefinition::Tier 0x74
	}
};
class AWeapon {
public:
...
public:
	...
	uintptr_t TeamIndex() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(uintptr_t*)(this + 0x1098); // FortPlayerStateAthena::TeamIndex 0x1098
	}
	int32_t SeasonLevelUIDisplay() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(int32_t*)(this + 0x10B0); //FortPlayerStateAthena::SeasonLevelUIDisplay 0x10B0
	}
...
public:
	AFortPawn* LocalPawn() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AFortPawn*)(*(uintptr_t*)((uintptr_t)this + 0x328)); //PlayerController::AcknowledgedPawn 0x328
	}

	APlayerCameraManager* PlayerCameraManager() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (APlayerCameraManager*)(*(uintptr_t*)(this + 0x338)); //PlayerController::PlayerCameraManager 0x338
	}
...
public: 
	UGameInstance* OwningGameInstance() {
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (UGameInstance*)(*(uintptr_t*)((uintptr_t)this + 0x1A8)); //World::OwningGameInstance 0x1A8
	}
